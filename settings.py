    ...
    def __init__(self):
        ...
        self.folder_dicts = [
            ...
            },
            {
                ...
                # Name each channel present (must be consistent for all images)
                'channels' : ["DAPI_ch",'RS_AIF1','RS_TNF','RS_IGF1'],
                'gammas' : [0.75,0.5, 0.5, 0.5],
                'RelativeIntensityThreshold' : [[1,5],[1.8,5],[1.8,5],[999,999]],

                # Path to folder containing images to be analyzed
                'Path' : "Z:\\People\\James\\Remyelination Expt (Drugz)\\AIF1-TNF-IGF1",
                #'Path' : "/Volumes/LABDATA/People/James/Remyelination Expt (Drugz)/Sox2-Ki67-Pdgfra RNAscope",

                # Cell types to analyze
                'cell_types_to_analyze' : ['DAPI', 'RS_RegenM-M_Total', 'RS_RegenM-M_Exclusive', 'RS_InflamM-M_Total','RS_InflamM-M_Exclusive', 'RS_MixedM-M' ],
                ...
                #type ["All"] if you wish to display all celltypes in cell locator
                'celltypesForCellLocations' : ['RS_RegenM-M_Exclusive','RS_InflamM-M_Exclusive', 'RS_MixedM-M' ],
